...
export function IssueListHeader() {
  ...
  return (
    <div className="flex items-center justify-between mb-6">
      <div>
        <h1 className="text-2xl font-semibold tracking-tight text-neutral-900">Issues</h1>
        <p className="text-sm text-neutral-500 mt-1">Track bugs, features, and tasks</p>
      </div>
